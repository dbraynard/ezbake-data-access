 ...
 */
public class EzHiveDriver implements Driver
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(EzHiveDriver.class);
    ...
    static
    {
        try
        {
            DriverManager.registerDriver(new EzHiveDriver());
        }
    ...
    public Connection connect(String url, Properties properties) throws SQLException
    {
        ...
        Driver realDriver = new org.apache.hive.jdbc.HiveDriver();
        Connection realConnection = realDriver.connect(unwrapURL(url), cloneProperties);
